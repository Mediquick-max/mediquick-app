...
import { LogIn, UserPlus, LogOut, ChevronDown, Store, Stethoscope, Pill, Home, X, Menu } from "lucide-react";
        ...
        <div className="max-w-3xl mx-auto px-4 h-16 flex items-center justify-between gap-4">
          <div className="flex items-center gap-4">
            ...
            <Link href="/" className="flex items-center gap-2.5 group" data-testid="link-home">
              ...
              <span className="font-bold text-lg tracking-tight text-foreground">Medi Quick</span>
            </Link>
          </div>
